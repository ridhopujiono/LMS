  ...
  <div class="container">
    <div class="firstMenu">
      ...
      <div class="container_CLASSROOM">
        <img src="{{asset('login/assets/imgs/Kelas_03.png')}}" />
      </div>

      <!-- BANNER -->
      <div class="container_BANNER">
        <img src="{{asset('login/assets/imgs/Cover_05.jpg')}}" />
      </div>
      ...
      <div class="container_TENTANG">
        <div class="area_TENTANG">
          ...
          <span class="text_TENTANG">
            Sespimti bertugas menyelenggarakan, menyusun, merumuskan program pendidikan, pengajaran, pelatihan, bimbingan atau pemeliharaan disiplin perwira siswa di lingkungan Sespimti.
          </span>
        </div>
      </div>
