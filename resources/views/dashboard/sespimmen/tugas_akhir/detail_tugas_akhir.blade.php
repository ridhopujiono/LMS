    ...
    <div class="page-content fade-in-up">
        <div class="ibox">
            ...
            <div class="ibox-body">
              ...
              table-bordered
              table-hover
            " id="example-table33" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            <th>Pengirim</th>
                            <th>POKJAR</th>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>{{$pu->nilai}}</td>
                            <td>
                                <a class="btn btn-xs btn-success text-white" download="" href="{{url('admin/sespimmen/file_upload_tugas_akhir')}}/{{$pu->file}}">
                                    <i class="fa fa-download"></i>
                                    <small><b>Unduh</b></small>
                                </a>
                                <a class="btn btn-xs btn-info text-white btn-lihat-tugas" href="{{url('admin/sespimmen/file_upload_tugas_akhir')}}/{{$pu->file}}">
                                    <i class="fa fa-eye"></i>
...
<script type="text/javascript">
    $(function() {
        $('#example-table33').DataTable({
            pageLength: 100,
        });
    });
    let url_post_nilai = "{{url('post_nilai_tugas_akhir')}}";
