...
<div class="content-wrapper">
    ...
    <div class="page-content fade-in-up">
            ...
            <div class="ibox-head">
                ...
                <div class="col-6 text-right text-white">
                    <div class="d-inline-block">
                        <a class="btn btn-xs btn-primary" href="{{url('tambah_tugas_akhir_sespimmen')}}">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                {{$d->deadline}} | {{$d->end}}</ </td>
                            <td>
                                <a class="btn btn-xs btn-info text-white" href="{{url('detail_tugas_akhir_sespimmen')}}/{{$d->id}}">
                                    <i class="fa fa-eye"></i>
        ...
        @else
        @foreach($data as $d)
        <a href="{{url('upload_tugas_akhir_sespimmen')}}/{{$d->id}}">
            <div class="ibox mb-3">
                <div class="ibox-body">
