                ...
                <div class="ibox">
                    ...
                    <div class="ibox-body">
                        <div id="container-tugas">
                            ...
                            <div class="form-group">
                                <a class="btn btn-success btn-block" href="{{url('admin/sespimmen/file_tugas_belajar')}}/{{$data->file}}" download="{{$data->nama_tugas}}"><span class="fa fa-download mr-2"></span>Unduh Tugas</a>
                            </div>
                        </div>
                        <div class="form-group form-penyerahan d-none">
                            <div class="alert alert-info name-file-tugas"></div>
                            <form action="{{url('upload_tugas_belajar_sespimmen')}}/{{$data->id}}" method="POST" enctype="multipart/form-data">
                                @csrf
