...
<head>
  ...
  <link rel="stylesheet" href="{{asset('login/styles/main.css')}}" />
  <title>{{$judul}}</title>
</head>
    ...
    <div class="firstMenu">
      ...
      <div class="container_HEADER">
        <div class="flex_HEADER">
          ...
          <div>
            <a href="lmssespim.lemdiklat.polri.go.id/" class="icon_HEADER">
      ...
      <div class="container_FOOTER">
        <div class="text_FOOTER">
          <p>Learning Management System (LMS) ini merupakan sistem pendukung</p>
          <p>pembelajaran jarak jauh berbasis digital Sespim Lemdiklat Polri</p>
          <hr class="seperator_FOOTER" />
        </div>
      </div>

      <!-- CLASSROOM -->
      <div class="container_CLASSROOM">
        <a href="{{url('bagian/sespimma')}}"><img src="{{asset('login/assets/imgs/Kelas_01.png')}}" width="100%" /></a>
        <a href="{{url('bagian/sespimmen')}}"><img src="{{asset('login/assets/imgs/Kelas_02.png')}}" width="100%" /></a>
        <a href="{{url('bagian/sespimmti')}}"><img src="{{asset('login/assets/imgs/Kelas_03.png')}}" width="100%" /></a>
      </div>
