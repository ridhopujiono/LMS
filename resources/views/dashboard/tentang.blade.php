...
<head>
  ...
  <link rel="stylesheet" href="{{asset('login/styles/tentang.css')}}" />
  <title>{{$judul}}</title>
</head>
    ...
    <div class="firstMenu">
      ...
      <div class="container_TENTANG">
        <div class="area_TENTANG">
          ...
          <span class="text_TENTANG">
            Learning Management System (LMS) ini merupakan piranti pendukung sistem
            pembelajaran jarak jauh berbaris digital Sespim Lemdiklat Polri.
          </span>
          <span class="text_TENTANG">
            Dengan adanya LMS ini diharapkan dapat menjadi piranti utama dalam
            proses pembelajaran Sespim Lemdiklat Polri, dan dapat menjadi pemantik
            dalam peningkatan kualitas pendidikan di Sespim Lemdiklat Polri, guna
            mewujudkan kepemimpinan polri yang presisi di era Revolusi Industri 4.0.
          </span>
          <span class="text_TENTANG">
            Silahkan anda menggunakan LMS ini dengan baik, sebagai bagian dari
            proses pembelajaran anda di Sespim Lemdiklat Polri.
          </span>
          <span class="text_TENTANG">
